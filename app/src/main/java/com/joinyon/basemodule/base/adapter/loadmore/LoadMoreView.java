package com.joinyon.basemodule.base.adapter.loadmore;
...
public abstract class LoadMoreView {
    ...
    public static final int STATUS_LOADING = 2;//加载状态
    public static final int STATUS_FAIL = 3;//失败状态
    public static final int STATUS_END = 4;//结束状态
