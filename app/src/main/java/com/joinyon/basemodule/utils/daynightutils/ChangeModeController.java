package com.joinyon.basemodule.utils.daynightutils;
...
import com.joinyon.basemodule.R;
...
public class ChangeModeController {
     ...
     * 属性一级字体颜色
     */
    private static final String ATTR_TEXT_COLOR = "dayNightOneTextColorAttr";
    /**
     * 属性二级字体颜色
     */
    private static final String ATTR_TWO_TEXT_COLOR = "dayNightTwoTextColorAttr";
    /**
     * 属性三级字体颜色
     */
    private static final String ATTR_THREE_TEXT_COLOR = "dayNightThreeTextColorAttr";
...
//                            Log.e("TAG", attrs.getAttributeName(i) + " , " + attrs.getAttributeValue(i));
                            ...
                            if (attrs.getAttributeName(i).equals(ATTR_TEXT_COLOR)) {
                                mOneTextColorViews.add(new AttrEntity<TextView>((TextView)view,getAttr(mClass,attrs.getAttributeValue(i))));
                            }
                            if (attrs.getAttributeName(i).equals(ATTR_TWO_TEXT_COLOR)) {
                                mOneTextColorViews.add(new AttrEntity<TextView>((TextView)view,getAttr(mClass,attrs.getAttributeValue(i))));
                            }
                            if (attrs.getAttributeName(i).equals(ATTR_THREE_TEXT_COLOR)) {
                                mOneTextColorViews.add(new AttrEntity<TextView>((TextView)view,getAttr(mClass,attrs.getAttributeValue(i))));
                            }
